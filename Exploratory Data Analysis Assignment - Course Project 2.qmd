...
total_emissions_vehicle <- bind_rows(total_emissions_vehicle_baltimore, total_emissions_vehicle_la)

# Create the graph with ggplot2
ggplot(total_emissions_vehicle, aes(x = year, y = total_emissions, color = city, group = city)) +
  geom_line() +
  geom_point() +
...
For saving your plots to PNG files, we can use pmg() function before each plot.
